/*
 * $Id: forcerec.h,v 1.38 2002/02/28 21:55:53 spoel Exp $
 * 
...
typedef struct {
  int           QMMMscheme;     /* ONIOM or normal                   */
  ...
  int           QMcharge;       /* charges of the QM system          */
  ...
  /* through a system call (i.e. system()) a user-defined QM package
   * can be used, provided it is able to use point charges. Until now
   * tis is only implemented for GAMESS-UK and ADF 
   * int           QMpackage; if !0, a system call is done  */
