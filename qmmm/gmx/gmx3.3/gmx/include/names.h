/*
 * $Id: names.h,v 1.21 2002/02/28 21:55:50 spoel Exp $
 * 
...
static char *SRCID_names_h = "$Id: names.h,v 1.21 2002/02/28 21:55:50 spoel Exp $";
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
extern char *eQMmethod_names[eQMmethodNR+1];
extern char *eQMbasis_names[eQMbasisNR+1];
extern char *eQMMMscheme_names[eQMMMschemeNR+1];
