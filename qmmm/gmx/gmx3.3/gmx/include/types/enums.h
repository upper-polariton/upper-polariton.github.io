...
enum {
  ...
  eQMmethodUHF, eQMmethodDFT, eQMmethodCASSCF,
...
/* OPT and TS only with QM/MM. with these integrators, the QM *
 * subsystem is optimized using the more sophisticated algorithms of *
 * the QM package, in the field of the protein, which in turn is
 * optimized using the STEEP algortithm.
 */
enum {
  eiMD, eiSteep, eiCG, eiBD, eiSD, eiNM, eiTS, eiOPT, eiNR
};
