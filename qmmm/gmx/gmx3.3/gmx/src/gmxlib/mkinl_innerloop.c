/*
 * $Id: mkinl_innerloop.c,v 1.10 2002/09/20 18:16:56 lindahl Exp $
 * 
 ...
 */
static char *SRCID_mkinl_innerloop_c = "$Id: mkinl_innerloop.c,v 1.10 2002/09/20 18:16:56 lindahl Exp $";
#include "mkinl.h"
