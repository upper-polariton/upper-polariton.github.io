/*
 * $Id: names.c,v 1.38 2002/02/28 10:49:28 spoel Exp $
 * 
 ...
 */
static char *SRCID_names_c = "$Id: names.c,v 1.38 2002/02/28 10:49:28 spoel Exp $";
#include "typedefs.h"
#include "names.h"
...
{ /* added TS at 12-5-2004 */
  "md", "steep", "cg", "bd", "sd", "nm", "TS", "OPT", NULL 
};
...
char *gtypes[egcNR+1] = {
  ...
  "User1", "QMMM", "VCM", "XTC", "Or. Res. Fit", NULL
};
...
char *eQMmethod_names[eQMmethodNR+1] = {
  "AM1", "PM3", "RHF", 
  "UHF", "DFT", "CASSCF", 
  "DIRECT", NULL
};

char *eQMbasis_names[eQMbasisNR+1] = {
  "STO3G", "STO-3G", "3-21G", 
  "3-21G*", "3-21+G*", "6-21G", 
  "6-31G", "6-31G*", "6-31+G*", 
  "6-311G", NULL
...
char *eQMMMscheme_names[eQMMMschemeNR+1] = {
  "normal", "ONIOM", NULL
};
