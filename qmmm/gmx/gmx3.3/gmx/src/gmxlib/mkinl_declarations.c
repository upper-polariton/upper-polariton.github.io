/*
 * $Id: mkinl_declarations.c,v 1.19 2002/09/20 18:16:56 lindahl Exp $
 * 
 ...
 */
static char *SRCID_mkinl_declarations_c = "$Id: mkinl_declarations.c,v 1.19 2002/09/20 18:16:56 lindahl Exp $";
#include "mkinl.h"
#include <string.h>
