/*
 * $Id: mkinl_interactions.c,v 1.20 2002/09/20 18:16:57 lindahl Exp $
 * 
 ...
 */
static char *SRCID_mkinl_interactions_c = "$Id: mkinl_interactions.c,v 1.20 2002/09/20 18:16:57 lindahl Exp $";
#include "mkinl.h"
#include <string.h>
