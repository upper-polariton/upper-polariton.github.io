/*
 * $Id: update.c,v 1.49 2002/07/01 03:26:48 justin Exp $
 * 
 ...
 */
static char *SRCID_update_c = "$Id: update.c,v 1.49 2002/07/01 03:26:48 justin Exp $";
#include <stdio.h>
#include <math.h>
